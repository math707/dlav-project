...
def normalize_phase_name(phase_name: str | None, default: str = 'phase1') -> str:
    candidate = (phase_name or default).strip().lower()
...
def prepare_project_context(
    ...
    resolved_phase_name = normalize_phase_name(phase_name)
    ...
    submissions_root = outputs_dir / 'submissions'
    runs_dir = runs_root / resolved_phase_name
    checkpoints_dir = checkpoints_root / resolved_phase_name
    submissions_dir = submissions_root / resolved_phase_name
    ...
    return ProjectContext(
        ...
        legacy_checkpoint_path=checkpoints_dir / f'{resolved_phase_name}_model.pth',
        legacy_submission_path=submissions_dir / f'submission_{resolved_phase_name}.csv',
